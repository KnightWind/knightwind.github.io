...
public class RollCallHanlder extends RequestHandler {

	public static final String TAG = "RollCallHanlder";
	...
	public void handleRequest(String request) {
		...
		if (request.contains(MinaUtil.MSG_ROLL_CALL_RSP)) {
			
			//Util.BIZ_CONF_DEBUG(TAG, "receive roll call msg");
			
			commManager.notifyConfChanged(CommunicationManager.ROLL_CALL);
